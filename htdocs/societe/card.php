...
if (is_object($objcanvas) && $objcanvas->displayCanvasExists($action))
{
	...
	if ($action == 'create')
	{
        ...
        print '<tr style="display: none;"><td>'.$form->editfieldkey('ThirdPartyType', 'typent_id', '', $object, 0).'</td><td class="maxwidthonsmartphone"'.($conf->browser->layout == 'phone' ? ' colspan="3"': '').'>'."\n";
	...
	} elseif ($action == 'edit')
	{
		...
		if ($socid)
		{
			...
			// Type - Workforce/Staff
			print '<tr style="display: none;"><td>'.$form->editfieldkey('ThirdPartyType', 'typent_id', '', $object, 0).'</td><td class="maxwidthonsmartphone">';
