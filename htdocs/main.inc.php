...
if (!defined('NOTOKENRENEWAL') && !defined('NOSESSION') && false) {
...
if (((!defined('NOCSRFCHECK') && empty($dolibarr_nocsrfcheck) && getDolGlobalInt('MAIN_SECURITY_CSRF_WITH_TOKEN')) || defined('CSRFCHECK_WITH_TOKEN')) && false) {
