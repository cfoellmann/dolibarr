		...
		*/
		...
		if ($action != 'presend' && $action != 'editline') {
			...
			if (empty($reshook)) {
				...
				{
					print '<div class="inline-block divButAction"><a class="butActionDelete" href="'.$_SERVER["PHP_SELF"].'?id='.$object->id.'&amp;action=cancel">'.$langs->trans("OrderButtonCancel").'</a></div>';
				}
